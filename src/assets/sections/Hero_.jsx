  ...
  return (
    ...
    >
      <div className="max-w-[600px] lg:mt-8 ">
        <h2 className="text-6xl  mb-5 font-bold max-sm:text-[48px] max-sm:leading-[60px] leading-[69px] text-gradient font-recoleta">
          ...
          <br />
          <span className="dark:text-white text-black_primary font-recoleta">Full Stack Web Developer</span>
        </h2>
        <p className="text-xl font-gordita">
